...
import { Building, Users, UsersRound, ShieldCheck, Settings, History, AlertTriangle, KeyRound, CalendarOff, CalendarSync } from 'lucide-react'
...
const CARDS: { label: string; Icon: typeof Users; href: string; requires: PermissionCode }[] = [
  ...
  { label: 'Leave Rollover', Icon: CalendarSync, href: '/system/leave-rollover', requires: 'MANAGE_LEAVE_ENTITLEMENTS' },
