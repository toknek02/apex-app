                ...
                {members.map((m, i) => {
                  ...
                  return (
                    <tr key={m.id} style={{ backgroundColor: i % 2 ? 'var(--apex-row-alt)' : '#fff' }}>
                      <td style={{ padding: '9px 14px', fontSize: 12, fontStyle: eventLabel ? 'normal' : 'italic', color: eventLabel ? 'var(--apex-text)' : 'var(--apex-muted)' }}>
                        {m.name}
                      </td>
                      <td style={{ padding: '9px 14px', fontSize: 12, color: eventLabel ? 'var(--apex-text)' : 'var(--apex-muted)' }}>
                        {eventLabel ?? 'Not logged in!'}
                      </td>
                      <td style={{ padding: '9px 14px', fontSize: 12, color: 'var(--apex-muted)' }}>{eventLabel ? project : ''}</td>
                      ...
                      <td style={{ padding: '9px 14px', fontSize: 12, color: 'var(--apex-muted)' }}>{eventLabel ? remarks : ''}</td>
                    </tr>
                  )
                })}
              </Fragment>
